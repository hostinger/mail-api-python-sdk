...
class TestV1FoldersCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1FoldersCollection:
        """Test V1FoldersCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1FoldersCollection`
        """
        model = V1FoldersCollection()
        if include_optional:
    ...
    def testV1FoldersCollection(self):
        """Test V1FoldersCollection"""
