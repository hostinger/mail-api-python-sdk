...
class TestV1FolderMessagesCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1FolderMessagesCollection:
        """Test V1FolderMessagesCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1FolderMessagesCollection`
        """
        model = V1FolderMessagesCollection()
        if include_optional:
    ...
    def testV1FolderMessagesCollection(self):
        """Test V1FolderMessagesCollection"""
