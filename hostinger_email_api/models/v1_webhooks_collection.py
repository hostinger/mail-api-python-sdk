...
class V1WebhooksCollection(BaseModel):
    """
    Paginated list of webhooks.
    """ # noqa: E501
    data: List[V1WebhooksWebhook]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V1WebhooksWebhook.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
