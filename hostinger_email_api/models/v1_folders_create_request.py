...
class V1FoldersCreateRequest(BaseModel):
    """
    Body for creating a folder.
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Folder name. Length 1-100 after trimming.")
