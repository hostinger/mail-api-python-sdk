...
class V1FoldersUpdateRequest(BaseModel):
    """
    Body for renaming a folder.
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="New folder name. Length 1-100 after trimming.")
