...
class V1FoldersCollection(BaseModel):
    """
    Paginated list of folders.
    """ # noqa: E501
    data: List[V1FoldersFolder]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V1FoldersFolder.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
