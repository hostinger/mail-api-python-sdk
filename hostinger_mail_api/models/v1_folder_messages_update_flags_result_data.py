...
class V1FolderMessagesUpdateFlagsResultData(BaseModel):
    """
    V1FolderMessagesUpdateFlagsResultData
    """ # noqa: E501
    successful: List[StrictInt]
    failed: List[V1FolderMessagesUpdateFlagsResultDataFailedInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed": [V1FolderMessagesUpdateFlagsResultDataFailedInner.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
